...
class AdvancedLottieAnimation extends ConsumerWidget {
  ...
  AdvancedLottieAnimation copyWith({
    ...
    return AdvancedLottieAnimation(
      ...
      isLottieAnimationVisible:
          isLottieAnimationVisible ?? this.isLottieAnimationVisible,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return AnimatedSwitcher(
      ...
      transitionBuilder: (child, animation) =>
          context.lottieSwitchAnimation(animation: animation, child: child),
      child: isLottieAnimationVisible
          ? _createLottieAnimation()
      ...
      child: Transform.scale(
        ...
        child: Lottie.asset(
          ...
          frameBuilder: (context, child, composition) =>
              context.lottieRenderingAnimation(
                  context: context, child: child, composition: composition),
          onLoaded: _onLoaded,
        ),
      ),
    );
