...
class AdvancedFloatingActionButton extends ConsumerWidget {
  ...
  Widget _getSmallWidget({
    required BuildContext context,
  }) {
    return FloatingActionButton.small(
      backgroundColor: context.appColors.primaryColor,
      foregroundColor: context.appColors.whiteTextColor,
      tooltip: tooltip,
      onPressed: onTap,
      child: Icon(icon),
    );
  ...
  Widget _getExtendedWidget({
    ...
    return FloatingActionButton.extended(
      ...
      icon: Icon(icon),
      label: Text(
        title?.isEmpty == true ? AppStrings.unknownText.text : title!,
        style: TextStyle(
