...
class AnimationConstants {
  ...
  static const int pageViewAnimationDurationMS = 300;

  /// Duration in milliseconds for loading animation extra delay duration.
  static const int loadingAnimationExtraDelayDurationMS = 2000;

  /// Duration in milliseconds for loading animation extra delay duration.
  static const int loadingAuthAnimationDurationMS = 3500;
